package com.hivenet.features.authentication.services;
...
import com.hivenet.features.authentication.utils.EmailService;
...
public class AuthenticationService {
    ...
    @PersistenceContext
    private EntityManager entityManager; // used to delete user likes id user is deleted
    ...
    public void sendEmailVerificationToken(String email) {
        ...
        if (user.isPresent() && !user.get().getEmailVerified()) {
            ...
            String body = String.format("Only one step to take full advantage of HiveNet.\n\n"
	...
	@Transactional // it is use to rollback if.. it failed to execute
